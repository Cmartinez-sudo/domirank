...
export function TournamentLeaderboard({
  ...
  return (
    <section ref={tableRef} className="card p-0 overflow-hidden" data-leaderboard="true">
      ...
      {/* Body — scroll horizontal para ver todas las columnas en mobile */}
      {standings.length === 0 && !loading ? (
        ...
        <div className="overflow-x-auto">
          <div className="min-w-[720px]">
            {/* Headers de columnas — scrollables junto con las filas */}
            <div className="flex items-center gap-2 px-4 py-2 border-b border-border/60 bg-surface-2/40">
              ...
              <div className="flex items-center gap-3 shrink-0">
                <Tooltip content="Últimas 5 partidas de este jugador en el torneo">
                  <span className="w-16 text-center text-[11px] font-semibold uppercase tracking-wider text-text-mute cursor-default">Forma</span>
                </Tooltip>
                <Tooltip content="Resultados consecutivos del mismo signo">
                  <span className="w-12 text-center text-[11px] font-semibold uppercase tracking-wider text-text-mute cursor-default">Racha</span>
                </Tooltip>
              </div>
            </div>
              ...
              displayed.map((row) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Stats numéricas — siempre visibles, scroll horizontal si no caben */}
                    <div className="flex items-center gap-4 shrink-0 font-mono text-sm tabular-nums">
